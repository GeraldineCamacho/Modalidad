...
#indicadores_clas$indba_prop_contr_finyr_total_hos <- NULL

#eliminar otros indicadores de supersalud que no yudaron
#indicadores_clas$supers_perc_pacientes_hipertension <- NULL
#indicadores_clas$supers_oportun_atencion_consulta_odonto_general <- NULL
#indicadores_clas$supers_oportun_asign_citas_consulta_general <- NULL
#indicadores_clas$supers_tasa_satis_global <- NULL
...
#indicadores_clas <- indicadores_clas %>% 
#  mutate(quartil = case_when(indba_perc_cdirec_num <= cartiles[2] ~ "Q1",
#                             indba_perc_cdirec_num <= cartiles[3] ~ "Q2",
#                             indba_perc_cdirec_num <= cartiles[4] ~ "Q3",
#                             TRUE ~ "Q4") )
...
muestra_indicadores_clas <- sample(2, nrow(indicadores_clas), replace = TRUE, prob = c(0.6, 0.4))
muestra_indicadores_clas <- indicadores_clas[ind == 1]
...
```{r}
rf_final_model_clas_test <- fit(rf_workflow_clas, testing(indicadores_clas_split))
