...
```{r}
RF_PCA_hospitales_todas_las_variables <- juice(pca_randomf_prep) %>%
...
RF_PCA_hospitales_todas_las_variables
```
...
```{r}
#Sin leyenda
ggsave("RF_PCA_hospitales_todas_las_variables_sin_leyenda.png",
       RF_PCA_hospitales_todas_las_variables)
...
```{r}
RF_UMAP_hospitales_todas_las_variables <- juice(umap_randomf_prep) %>%
...
RF_UMAP_hospitales_todas_las_variables
```
...
```{r}
#sin leyenda
ggsave("RF_UMAP_todas_las_variables_sin_leyenda.png",
       RF_UMAP_hospitales_todas_las_variables)
