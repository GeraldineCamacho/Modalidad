...
variables_info_directa <- c(
  ...
  "indba_perc_direc_val",
  "indba_perc_cerrada_num",
  "indba_perc_cerrada_val",
  # Fin de año (finyr)
...
Con variable indba_prop_contr_finyr_total_hos el
ACC bajo de 0,671 a 0,666
ROC subió de 0,736 a 0,748
GINI bajó de 0,2589 a 0,2579
