...
# Filtrar los que no coinciden por NIT pero sí por nombre para hacer un merge y así reemplazar los NIT erroneos de secop, luego hacer un rbind para pegar las filas y ya
coinciden_prueba <- indicadores_prueba %>% 
...
coinciden_super <- supersalud %>% filter(Entidad %in% coinciden_prueba$Hospital)
