...
```{r}
SECOP_I <- SECOP_I %>%
  filter(cuantia_contrato >= 1000000)
#199612 menores a 1 millon
```
...
entidades_del <- SECOP_I %>% 
  ...
  summarise(contratos = n(), 
            totalcuantia = sum(cuantia_contrato),
            Total = sum(valor_total_con_adiciones)) %>% 
  filter(contratos < 3)
...
Eliminar contrato inconsistente en url

```{r}
SECOP_I<- SECOP_I %>% 
  filter( !(ruta_web == "https://www.contratos.gov.co/consultas/detalleProceso.do?numConstancia=19-4-9698012" | 
           ruta_web == "https://www.contratos.gov.co/consultas/detalleProceso.do?numConstancia=19-4-10052147" |
           ruta_web == "https://www.contratos.gov.co/consultas/detalleProceso.do?numConstancia=19-4-8913220" |
           ruta_web == "https://www.contratos.gov.co/consultas/detalleProceso.do?numConstancia=19-4-9987612" |
           ruta_web == "https://www.contratos.gov.co/consultas/detalleProceso.do?numConstancia=16-4-5104616" |
           ruta_web == "https://www.contratos.gov.co/consultas/detalleProceso.do?numConstancia=17-4-7118568"))
```

## Correción valores

Pasar SECOP_I como datatable

```{r}
SECOP_I <- as.data.table(SECOP_I)
```

### Correción cuantía proceso

Superiores a 1 billón de pesos
...
Entre 50 mil millones y 1 billon
...
Entre 20 mil millones  50 mil millones (67,30%)
...
#2
SECOP_I[ruta_web == "https://www.contratos.gov.co/consultas/detalleProceso.do?numConstancia=16-12-5172694", cuantia_contrato := 45600000]
SECOP_I[ruta_web == "https://www.contratos.gov.co/consultas/detalleProceso.do?numConstancia=19-4-9895596", cuantia_contrato := 23150000]
SECOP_I[ruta_web == "https://www.contratos.gov.co/consultas/detalleProceso.do?numConstancia=16-12-4943670", cuantia_contrato := 29370000]
SECOP_I[ruta_web == "https://www.contratos.gov.co/consultas/detalleProceso.do?numConstancia=19-4-9147638", cuantia_contrato := 40920000]
SECOP_I[ruta_web == "https://www.contratos.gov.co/consultas/detalleProceso.do?numConstancia=18-4-8008383", cuantia_contrato := 31060806]
SECOP_I[ruta_web == "https://www.contratos.gov.co/consultas/detalleProceso.do?numConstancia=19-4-9128677", cuantia_contrato := 22400000]
SECOP_I[ruta_web == "https://www.contratos.gov.co/consultas/detalleProceso.do?numConstancia=19-4-9428778", cuantia_contrato := 28560000]
SECOP_I[ruta_web == "https://www.contratos.gov.co/consultas/detalleProceso.do?numConstancia=15-4-4375457", cuantia_contrato := 40000000]
#3
SECOP_I[ruta_web == "https://www.contratos.gov.co/consultas/detalleProceso.do?numConstancia=19-12-10047431", cuantia_contrato := 31440000]
SECOP_I[ruta_web == "https://www.contratos.gov.co/consultas/detalleProceso.do?numConstancia=15-4-4499254", cuantia_contrato := 24500000]
SECOP_I[ruta_web == "https://www.contratos.gov.co/consultas/detalleProceso.do?numConstancia=16-12-5917545", cuantia_contrato := 28800000]
SECOP_I[ruta_web == "https://www.contratos.gov.co/consultas/detalleProceso.do?numConstancia=19-12-8905665", cuantia_contrato := 21600000]
SECOP_I[ruta_web == "https://www.contratos.gov.co/consultas/detalleProceso.do?numConstancia=14-4-2562934", cuantia_contrato := 22750000]
SECOP_I[ruta_web == "https://www.contratos.gov.co/consultas/detalleProceso.do?numConstancia=19-4-9405450", cuantia_contrato := 40920000]
SECOP_I[ruta_web == "https://www.contratos.gov.co/consultas/detalleProceso.do?numConstancia=19-12-9489430", cuantia_contrato := 32900000]
SECOP_I[ruta_web == "https://www.contratos.gov.co/consultas/detalleProceso.do?numConstancia=19-4-9974280", cuantia_contrato := 30000000]
#4
SECOP_I[ruta_web == "https://www.contratos.gov.co/consultas/detalleProceso.do?numConstancia=16-4-4651217", cuantia_contrato := 20000000]
SECOP_I[ruta_web == "https://www.contratos.gov.co/consultas/detalleProceso.do?numConstancia=15-12-3699296", cuantia_contrato := 36450000]
SECOP_I[ruta_web == "https://www.contratos.gov.co/consultas/detalleProceso.do?numConstancia=19-4-8951933", cuantia_contrato := 21000000]
SECOP_I[ruta_web == "https://www.contratos.gov.co/consultas/detalleProceso.do?numConstancia=19-4-8913225", cuantia_contrato := 21980121]
SECOP_I[ruta_web == "https://www.contratos.gov.co/consultas/detalleProceso.do?numConstancia=18-4-8811045", cuantia_contrato := 22662000]
SECOP_I[ruta_web == "https://www.contratos.gov.co/consultas/detalleProceso.do?numConstancia=16-4-5773004", cuantia_contrato := 21171440]
#5
SECOP_I[ruta_web == "https://www.contratos.gov.co/consultas/detalleProceso.do?numConstancia=18-4-7718179", cuantia_contrato := 9330000]
SECOP_I[ruta_web == "https://www.contratos.gov.co/consultas/detalleProceso.do?numConstancia=19-4-9948624", cuantia_contrato := 21600000]
SECOP_I[ruta_web == "https://www.contratos.gov.co/consultas/detalleProceso.do?numConstancia=19-4-9288960", cuantia_contrato := 24000000]
SECOP_I[ruta_web == "https://www.contratos.gov.co/consultas/detalleProceso.do?numConstancia=17-12-7346989", cuantia_contrato := 24000000]
SECOP_I[ruta_web == "https://www.contratos.gov.co/consultas/detalleProceso.do?numConstancia=18-4-8098242", cuantia_contrato := 334230134]
#6
SECOP_I[ruta_web == "https://www.contratos.gov.co/consultas/detalleProceso.do?numConstancia=14-4-2607920", cuantia_contrato := 23100000]
SECOP_I[ruta_web == "https://www.contratos.gov.co/consultas/detalleProceso.do?numConstancia=15-4-4397795", cuantia_contrato := 32623000]
```

Entre 10 mil millones  20 mil millones (29/59 - 49,15%)

```{r}
#1
SECOP_I[ruta_web == "https://www.contratos.gov.co/consultas/detalleProceso.do?numConstancia=15-4-3568302", cuantia_contrato := 17300000]
SECOP_I[ruta_web == "https://www.contratos.gov.co/consultas/detalleProceso.do?numConstancia=19-4-9012259", cuantia_contrato := 18000000]
SECOP_I[ruta_web == "https://www.contratos.gov.co/consultas/detalleProceso.do?numConstancia=16-4-5068394", cuantia_contrato := 1259000000]
#2
SECOP_I[ruta_web == "https://www.contratos.gov.co/consultas/detalleProceso.do?numConstancia=16-4-4709528", cuantia_contrato := 13800000]
SECOP_I[ruta_web == "https://www.contratos.gov.co/consultas/detalleProceso.do?numConstancia=17-4-6509274", cuantia_contrato := 19800000]
SECOP_I[ruta_web == "https://www.contratos.gov.co/consultas/detalleProceso.do?numConstancia=19-4-8929192", cuantia_contrato := 19400000]
SECOP_I[ruta_web == "https://www.contratos.gov.co/consultas/detalleProceso.do?numConstancia=17-4-6030223", cuantia_contrato := 10400000]
#3
SECOP_I[ruta_web == "https://www.contratos.gov.co/consultas/detalleProceso.do?numConstancia=15-4-3403159", cuantia_contrato := 11100000]
SECOP_I[ruta_web == "https://www.contratos.gov.co/consultas/detalleProceso.do?numConstancia=19-4-9191826", cuantia_contrato := 10940800]
SECOP_I[ruta_web == "https://www.contratos.gov.co/consultas/detalleProceso.do?numConstancia=19-4-9478664", cuantia_contrato := 13374000]
SECOP_I[ruta_web == "https://www.contratos.gov.co/consultas/detalleProceso.do?numConstancia=17-4-6028966", cuantia_contrato := 18000000]
SECOP_I[ruta_web == "https://www.contratos.gov.co/consultas/detalleProceso.do?numConstancia=16-4-5016733", cuantia_contrato := 17272000]
#4
SECOP_I[ruta_web == "https://www.contratos.gov.co/consultas/detalleProceso.do?numConstancia=17-4-6029057", cuantia_contrato := 15600000]
SECOP_I[ruta_web == "https://www.contratos.gov.co/consultas/detalleProceso.do?numConstancia=17-4-7021201", cuantia_contrato := 11340000]
SECOP_I[ruta_web == "https://www.contratos.gov.co/consultas/detalleProceso.do?numConstancia=17-4-6356616", cuantia_contrato := 10800000]
SECOP_I[ruta_web == "https://www.contratos.gov.co/consultas/detalleProceso.do?numConstancia=17-4-6163590", cuantia_contrato := 14175000]
SECOP_I[ruta_web == "https://www.contratos.gov.co/consultas/detalleProceso.do?numConstancia=18-4-8684330", cuantia_contrato := 146670174]
#5
SECOP_I[ruta_web == "https://www.contratos.gov.co/consultas/detalleProceso.do?numConstancia=17-4-6354435", cuantia_contrato := 16285000]
SECOP_I[ruta_web == "https://www.contratos.gov.co/consultas/detalleProceso.do?numConstancia=15-4-4416097", cuantia_contrato := 19600000]
SECOP_I[ruta_web == "https://www.contratos.gov.co/consultas/detalleProceso.do?numConstancia=19-4-9346213", cuantia_contrato := 16400000]
SECOP_I[ruta_web == "https://www.contratos.gov.co/consultas/detalleProceso.do?numConstancia=16-12-4592007", cuantia_contrato := 18348000]
SECOP_I[ruta_web == "https://www.contratos.gov.co/consultas/detalleProceso.do?numConstancia=15-4-4203093", cuantia_contrato := 13700000]
SECOP_I[ruta_web == "https://www.contratos.gov.co/consultas/detalleProceso.do?numConstancia=19-12-9116437", cuantia_contrato := 19200000]
#6
SECOP_I[ruta_web == "https://www.contratos.gov.co/consultas/detalleProceso.do?numConstancia=19-4-9903052", cuantia_contrato := 11324000]
SECOP_I[ruta_web == "https://www.contratos.gov.co/consultas/detalleProceso.do?numConstancia=18-4-7574651", cuantia_contrato := 17200000]
SECOP_I[ruta_web == "https://www.contratos.gov.co/consultas/detalleProceso.do?numConstancia=17-4-7258687", cuantia_contrato := 12100000]
SECOP_I[ruta_web == "https://www.contratos.gov.co/consultas/detalleProceso.do?numConstancia=15-4-3341874", cuantia_contrato := 16800000]
#7
SECOP_I[ruta_web == "https://www.contratos.gov.co/consultas/detalleProceso.do?numConstancia=18-4-7574462", cuantia_contrato := 17200000]
SECOP_I[ruta_web == "https://www.contratos.gov.co/consultas/detalleProceso.do?numConstancia=15-4-4349182", cuantia_contrato := 13423670]
```

Otros contratos hallados mientras se revisaba valor_adiciones

```{r}
SECOP_I[ruta_web == "https://www.contratos.gov.co/consultas/detalleProceso.do?numConstancia=15-1-134063", cuantia_contrato := 156241000000]
SECOP_I[ruta_web == "https://www.contratos.gov.co/consultas/detalleProceso.do?numConstancia=19-4-9196726", cuantia_contrato := 81940389]
SECOP_I[ruta_web == "https://www.contratos.gov.co/consultas/detalleProceso.do?numConstancia=15-4-3579675", cuantia_contrato := 3000000000]
```

### Corrección valor adiciones

Mayores a 100 mil millones (5/5)
...
30 mil millones  y 100 mil millones (4/4)

```{r}
SECOP_I[ruta_web == "https://www.contratos.gov.co/consultas/detalleProceso.do?numConstancia=19-4-8963897", valor_adiciones := 56500000 ]
#Valor menor en cuantia en la BD que en el PDF
SECOP_I[ruta_web == "https://www.contratos.gov.co/consultas/detalleProceso.do?numConstancia=15-1-134063", valor_adiciones := 68200000000]
SECOP_I[ruta_web == "https://www.contratos.gov.co/consultas/detalleProceso.do?numConstancia=14-4-2735068", valor_adiciones := 184490110]
SECOP_I[ruta_web == "https://www.contratos.gov.co/consultas/detalleProceso.do?numConstancia=19-4-9196726", valor_adiciones := 33116571]
```

20 mil millones  y 30 mil millones (3/3)

```{r}
SECOP_I[ruta_web == "https://www.contratos.gov.co/consultas/detalleProceso.do?numConstancia=15-4-3579675", valor_adiciones := 28379242431]
SECOP_I[ruta_web == "https://www.contratos.gov.co/consultas/detalleProceso.do?numConstancia=15-4-3579675", cuantia_contrato := 3000000000]
SECOP_I[ruta_web == "https://www.contratos.gov.co/consultas/detalleProceso.do?numConstancia=15-4-3330822", valor_adiciones := 28599781]
```

15 mil millones  y 20 mil millones (2/3)

```{r}
SECOP_I[ruta_web == "https://www.contratos.gov.co/consultas/detalleProceso.do?numConstancia=14-4-2741645", valor_adiciones := 18432000]
#Contrato con un valor menor en la bd del real
SECOP_I[ruta_web == "https://www.contratos.gov.co/consultas/detalleProceso.do?numConstancia=16-4-5104616", valor_adiciones := 78385000000]
```

10 mil millones  y 15 mil millones (1/6)

```{r}
SECOP_I[ruta_web == "https://www.contratos.gov.co/consultas/detalleProceso.do?numConstancia=15-4-3630909", valor_adiciones := 27562580000]
```

Otros contratos hallados mientras se revisaba cuantia_contrato

```{r}
SECOP_I[ruta_web == "https://www.contratos.gov.co/consultas/detalleProceso.do?numConstancia=19-4-8913225", valor_adiciones := 46060070] # Ajuste de una adición que no se estaba teniendo en cuenta
SECOP_I[ruta_web == "https://www.contratos.gov.co/consultas/detalleProceso.do?numConstancia=15-12-3498435", valor_adiciones := 3431450000] # esto va en la parte de geraldine
SECOP_I[ruta_web == "https://www.contratos.gov.co/consultas/detalleProceso.do?numConstancia=19-4-9044370", valor_adiciones := 3300000] # este va en la parte de geraldine 
```

## Crear columna de los modificados

```{r}
SECOP_I <- SECOP_I %>% 
  mutate(valor_total_con_adiciones_mod = cuantia_contrato + valor_adiciones,
         corregido = case_when(valor_total_con_adiciones != valor_total_con_adiciones_mod ~ 1,
                               TRUE ~ 0))
```

## Escribir la base de datos LIMPIA
...
```{r}
fwrite(SECOP_I_2, file = "SECOP_IPS_LIMPIA.csv", 
       sep = ";", 
       row.names = FALSE)
```
...
Entre 20 mil millones  50 mil millones
...
Entre 10 mil millones  20 mil millones

```{r}
datatable(SECOP_I %>% filter(cuantia_contrato >= 10000000000 & cuantia_contrato < 20000000000) %>%
    dplyr::select(cuantia_proceso, valor_adiciones, cuantia_contrato, valor_total_con_adiciones, ruta_web))
```
