...
Entre 5 y 10 mil millones hay 272 contratos

```{r}
datatable(SECOP_I %>% filter(cuantia_contrato >= 5000000000 & cuantia_contrato < 10000000000) %>%
    dplyr::select(cuantia_proceso, valor_adiciones, cuantia_contrato, valor_total_con_adiciones, ruta_web))
```
...
10 mil millones  y 100 mil millones

```{r}
datatable(SECOP_I %>% filter(valor_adiciones >= 10000000000 & valor_adiciones <= 100000000000) %>%
    dplyr::select(cuantia_proceso, valor_adiciones, cuantia_contrato, valor_total_con_adiciones, ruta_web))
```


```{r}
SECOP_I[ruta_web == "", valor_adiciones := ]
SECOP_I[ruta_web == "", valor_adiciones := ]
SECOP_I[ruta_web == "", valor_adiciones := ]
SECOP_I[ruta_web == "", valor_adiciones := ]
SECOP_I[ruta_web == "", valor_adiciones := ]
