...
```{r}
# Suma total
XGB_Importancia_niveles_total_indba <- importantes_xgb %>%
...
# Suma media
XGB_Importancia_niveles_media_indba <- importantes_xgb %>%
  filter(fin == "hos" | fin == "mun" | fin == "dto") %>% 
  group_by(fin) %>% 
...
XGB_Importancia_niveles_total_indba
XGB_Importancia_niveles_media_indba
```
...
```{r}
# Total
ggsave("XGB_Importancia_niveles_total_indba.png",
       XGB_Importancia_niveles_total_indba)

# Media
ggsave("XGB_Importancia_niveles_media_indba.png",
       XGB_Importancia_niveles_media_indba)
```
