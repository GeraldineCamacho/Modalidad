...
```{r}
entidades %>% rename("indba_ptr_contratos_minima_cuantia_hos" = indba_contratos_minima_cuantia_hos,
...
Unir la repitencia contratista con la cantidad de contratos por cada contratista en promedio
